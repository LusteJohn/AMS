...
import '../assets/admin/StudentAttendance.css'
...
async function loadData() {
	...
	try {
		const [attendanceResponse, companiesResponse] = await Promise.all([
...
@media (max-width: 700px) { .admin-layout { display: block; } .attendance-page { padding: 24px 16px; } .page-header { align-items: start; flex-direction: column; } .clear-button { margin-left: 0; } }
</style>
