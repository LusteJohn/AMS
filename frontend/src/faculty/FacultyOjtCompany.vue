...
import '../assets/faculty/FacultyOjtCompany.css'
  ...
  <div class="faculty-layout">
    ...
    <main class="company-page">
      <header class="page-header">
        <div>
          <p class="eyebrow">Faculty placement</p>
          <h1>OJT companies</h1>
          <p>View available companies and manage company details.</p>
        </div>
...
@media (max-width: 700px) { .faculty-layout { display: block; } .company-page { padding: 24px 16px; overflow-x: auto; } .page-header { align-items: start; flex-direction: column; } }
</style>
